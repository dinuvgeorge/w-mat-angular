export const demoComponentsList = [
  {
    name: 'Grids', route: '/components/grid',
    children: [
  ...
  {
    name: 'Tree Grids', route: '/components/tree-grid',
    children: [
  ...
  {
    name: 'Calendars', route: '/components/date-picker',
    children: [
      {name: 'Date Picker', route: '/components/date-picker/overview'}
    ]
  },
  {
    name: 'DropDowns', route: '/components/drop-downs',
    children: [
  ...
  {
    name: 'Editors', route: '/components/editors',
    children: [
  ...
  {
    name: 'Layout', route: '/components/layout',
    children: [
  ...
  {
    name: 'Lists', route: '/components/lists',
    children: [
  ...
  {
    name: 'Navigations', route: '/components/navigations',
    children: [
  ...
  {
    name: 'Notifications', route: '/components/notifications',
    children: [
      {name: 'Progress Bar', route: '/components/notifications/progress-bar'},
      {name: 'Progress Spinner', route: '/components/navigations/progress-spinner'},
